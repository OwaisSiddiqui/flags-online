  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="text-xl px-6 py-4 drop-shadow-md bg-white border-white border-2 rounded-full"
      />
      {errors.repeatPassword?.message === "Required" && (
  ...
  return (
    ...
    >
      <input
        ...
        className="text-xl px-6 py-4 drop-shadow-md bg-white border-white border-2 rounded-full"
      />
      {errors.username?.message === "User does not exist" && (
        <span className="bg-red-300 text-red-700 p-4">
      ...
      />
      {loginError && (
        <span className="bg-red-300 text-red-700 p-4">{loginError}</span>
      )}
      <button
        type="submit"
        className="bg-transparent w-32 rounded-full text-lg py-3 text-black border-4"
